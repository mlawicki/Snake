...
namespace Snake
{
    public partial class Form1 : Form
    {
        ...
        private void zacznijGre()
        {
            ...
            new Ustawienia();
            Snake.Clear();
            Czesci poczatekWeza = new Czesci() {X = 10, Y = 10};
        ...
        private void Rysuj(object sender, PaintEventArgs e)
        {
            ...
            if (Ustawienia.KoniecGry == false)
            {
                ...
                for (int i = 0; i < Snake.Count; i++)
                {
                    ...
                    tlo.FillEllipse(Brushes.White,new Rectangle(obiekt.X*Ustawienia.Szerokosc,Ustawienia.Wysokosc,Ustawienia.Szerokosc,Ustawienia.Wysokosc));
                }
            }
